...
export default function Showtime() {
  ...
  const [phase, setPhase] = useState<UnwrapPhase>(UnwrapPhase.INTRO_TEXT);
  const t = useTranslations('Common');
  
  const validData = !!params.id && !!searchParams.get('token');
